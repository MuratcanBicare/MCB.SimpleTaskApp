...
using MCB.SimpleTaskApp.Tests.TestDatas;
using MCB.SimpleTaskApp.Web.Controllers;
using MCB.SimpleTaskApp.Web.Startup;
using MCB.SimpleTaskApp.Web.Tests.Controllers;
    ...
    public abstract class SimpleTaskAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SimpleTaskAppWebModule).Assembly.FullName);
        }
